export const merchantText = {
  de: {
    ...
    offerLocationHelp:'Produkt und Standort eines bestehenden Angebots bleiben fest. Lege für einen anderen Standort ein weiteres Angebot an.', checkout:'Online-Kauf und Reservierung sind noch nicht freigeschaltet.',
  ...
  en: {
    ...
    offerLocationHelp:'A saved offer keeps its product and location. Create another offer for a different location.', checkout:'Online checkout and reservations are not yet available.',
