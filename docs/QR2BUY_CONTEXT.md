...
P0.3.4-Rollout jetzt ausdrücklich freigegeben: erneute vollständige lokale Prüfung grün. Veröffentlichung, erforderlicher Ingress/Operator-Scope und anschließend Firmware/erste reale Bindung ausschließlich für QR2B-000001 sind beauftragt. Noch keine reale Produktbindung bestätigt. QR2B-000002 bleibt ohne Flash/Preview/Aktivierung PENDING und assigned=false, bis ein separates Go erfolgt.
