...
Aktuell: P0.3.3a ist produktiv provisioniert und API-seitig geprüft. Zwei permanente Devices sind vorbereitet; ihre DisplayAssignments bleiben PENDING. Noch kein Merchant-Firmware-Flash. Details und Grenzen stehen im P0.3.3a-Abschnitt unten.
